...
class UserPasswordReset extends ResetPassword
{
    ...
    public function onRestorePassword()
    {
        ...
        $data = [
            ...
            'link' => $link,
            'code' => $code,
            'logo' => 'http://173.231.105.250/themes/esecurity/assets/images/pax-webinar-logo.png'
        ];

        Mail::send('esecurity.account::mail.restore_password_' . $user->language, $data, function ($message) use ($user) {
